...
$('document').ready(function(){
		...
		$(window).resize(function(){
			 vw = $(window).width()/2;
			$('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9,#b10,#b01,#b12').stop();
			...
			$('#b88').animate({top:240, left: vw+20},500);
			$('#b99').animate({top:240, left: vw+20},500);
			$('#b109').animate({top:240, left: vw+20},500);
			$('#b119').animate({top:240, left: vw+20},500);
			$('#b129').animate({top:240, left: vw+20},500);
		});
	...
	function loopEleven() {
		var randleft = 1000*Math.random();
		var randtop = 500*Math.random();
		$('#b01').animate({left:randleft,bottom:randtop},10000,function(){
			loopEleven();
		});
	}
	function loopTwelve() {
	...
	$('#balloons_flying').click(function(){
		...
		$('#b2,#b3,#b6,#b8,#b9,#b01').addClass('balloons-rotate-behaviour-two');
	...
	$('#story').click(function(){
		...
		function msgLoop (i) {
			...
			i=i+1;
			$("p:nth-child("+i+")").fadeIn('slow').delay(3300);
			if(i==50){
